...
# az storage container generate-sas --account-key storagesaskey --account-name cheuw001assetsstcool -n originals-de1885b94150-d6f6b9f9-f2eb-42cf-96c5-fe0be098fef3 --permissions r --expiry $expiry --https-only
